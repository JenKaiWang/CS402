...
public class IntegerSecond {
    public static void main(String[] args) {
        ...
        // Perform matrix multiplication with row in the inner loop
        ...
        System.out.println("Result Matrix (Naive Row):");
        displayMatrix(result);

        // Calculate and display the elapsed time
        double elapsedTime = (endTime - startTime) / 1_000_000_000.0;
        System.out.println("IntegerSecond Program execution time: " + elapsedTime + " seconds");
    }
    ...
    // Function to multiply two matrices with row in the inner loop
